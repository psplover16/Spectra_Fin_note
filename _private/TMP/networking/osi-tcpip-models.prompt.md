...
route: /networking
subject: networking
source_file: _private/網概.txt
source_section: 五、OSI 7 層與 TCP/IP 5 層
source_labels: [必背], [比較], [會算], [會畫]
source_label_definitions: ../source-label-definitions.md
content_shape: lessonArticle
generated_at: "2026-06-13T11:15:00+08:00"
---

# OSI 7 層與 TCP/IP 5 層 Prompt

## Writer Scope

- 只處理 topic id: osi-tcpip-models
- 只讀來源：_private/網概.txt
- 來源段落：五、OSI 7 層與 TCP/IP 5 層
...
以 OSI 7 層與 TCP/IP 5 層 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
