...
source_section: 七、Tree
source_labels: [必背], [比較], [會算], [會做]
source_label_definitions: ../source-label-definitions.md
content_shape: lessonArticle
generated_at: "2026-06-13T12:30:00+08:00"
---

# 樹(Tree)與二元樹(Binary Tree) Prompt

## Writer Scope

- 只處理 topic id: tree-and-binary-tree
...
以 樹(Tree)與二元樹(Binary Tree) 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
