...
source_section: 五、Linked List
source_labels: [必背], [比較], [會寫虛擬碼]
source_label_definitions: ../source-label-definitions.md
content_shape: lessonArticle
generated_at: "2026-06-13T12:30:00+08:00"
---

# 鏈結串列(Linked List)與基本操作 Prompt

## Writer Scope

- 只處理 topic id: linked-list-basics
...
以 鏈結串列(Linked List)與基本操作 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
