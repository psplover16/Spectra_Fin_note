...
source_section: 十一、雜湊法（Hashing）
source_labels: [必背], [比較], [補充]
source_label_definitions: ../source-label-definitions.md
content_shape: lessonArticle
generated_at: "2026-06-13T12:30:00+08:00"
---

# 雜湊法(Hashing)與碰撞處理 Prompt

## Writer Scope

- 只處理 topic id: hashing-and-collision-handling
...
以 雜湊法(Hashing)與碰撞處理 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
