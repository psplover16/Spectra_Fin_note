...
source_section: 八、圖（Graph）
source_labels: [必背], [比較], [會做]
source_label_definitions: ../source-label-definitions.md
content_shape: lessonArticle
generated_at: "2026-06-13T12:30:00+08:00"
---

# 圖(Graph)、DFS/BFS、MST 與最短路徑 Prompt

## Writer Scope

- 只處理 topic id: graph-traversal-and-paths
...
以 圖(Graph)、DFS/BFS、MST 與最短路徑 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
