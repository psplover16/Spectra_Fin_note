...
# 高等樹: AVL、B Tree、Heap、Red-Black Tree Prompt

## Writer Scope

- 只處理 topic id: advanced-balanced-trees
...
以 高等樹: AVL、B Tree、Heap、Red-Black Tree 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
