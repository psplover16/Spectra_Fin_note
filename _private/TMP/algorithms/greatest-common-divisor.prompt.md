...
route: /algorithms
subject: algorithms
source_file: _private/國考常見演算法_Java遞迴非遞迴_時間複雜度.md
source_section: 四、最大公因數 GCD
source_labels: [必背], [會寫], [會算]
...
- 只處理 topic id: greatest-common-divisor
- 只讀來源：_private/國考常見演算法_Java遞迴非遞迴_時間複雜度.md
- 來源段落：四、最大公因數 GCD
...
以 最大公因數 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
