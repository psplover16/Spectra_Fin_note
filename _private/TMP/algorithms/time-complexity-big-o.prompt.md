...
# 時間複雜度(Time Complexity)與 Big O Prompt

## Writer Scope

- 只處理 topic id: time-complexity-big-o
...
以 時間複雜度(Time Complexity)與 Big O 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
