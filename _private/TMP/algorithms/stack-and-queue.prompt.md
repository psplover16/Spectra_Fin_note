...
source_section: 六、Stack 與 Queue
source_labels: [必背], [比較], [會算]
source_label_definitions: ../source-label-definitions.md
content_shape: lessonArticle
generated_at: "2026-06-13T12:30:00+08:00"
---

# 堆疊(Stack)與佇列(Queue) Prompt

## Writer Scope

- 只處理 topic id: stack-and-queue
- 只讀來源：_private/資料結構與演算法.txt
- 來源段落：六、Stack 與 Queue
...
以 堆疊(Stack)與佇列(Queue) 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
