...
route: /algorithms
subject: algorithms
source_file: _private/資料結構與演算法.txt
source_section: 二、演算法
source_labels: [必背]
...
# 演算法(Algorithm)定義與五大條件 Prompt

## Writer Scope

- 只處理 topic id: algorithm-definition-and-properties
- 只讀來源：_private/資料結構與演算法.txt
- 來源段落：二、演算法
...
以 演算法(Algorithm)定義與五大條件 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
