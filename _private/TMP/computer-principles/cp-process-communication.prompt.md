...
source_section: 3c. 作業系統 / Process Communication
source_labels: [必背], [比較]
...
# Process Communication Prompt

## Writer Scope

- 只處理 topic id: cp-process-communication
- 只讀來源：_private/計算機概論.txt
- 來源段落：3c. 作業系統 / Process Communication
...
以 Process Communication 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
