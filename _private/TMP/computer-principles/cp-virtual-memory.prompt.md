...
# Virtual Memory Prompt

## Writer Scope

- 只處理 topic id: cp-virtual-memory
- 只讀來源：_private/計算機概論.txt
- 來源段落：3c. 作業系統 / Virtual Memory
...
以 Virtual Memory 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
