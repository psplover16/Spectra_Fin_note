...
source_section: 3a. 基本計概 / 機器指令與指令週期
source_labels: [必背]
...
- 只處理 topic id: cp-machine-instruction-cycle
- 只讀來源：_private/計算機概論.txt
- 來源段落：3a. 基本計概 / 機器指令與指令週期
...
以 機器指令與指令週期 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
