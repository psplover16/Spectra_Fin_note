...
- 只處理 topic id: cp-hardware-protection
...
- topic id: `cp-hardware-protection`
- route: `/computer-principles`
...
以 硬體保護 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
