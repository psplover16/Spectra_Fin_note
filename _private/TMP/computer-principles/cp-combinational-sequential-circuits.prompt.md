---
topic_id: cp-combinational-sequential-circuits
formal_topic_id: cp-combinational-sequential-circuits
route: /computer-principles
subject: computerPrinciples
source_file: _private/計算機概論.txt
source_section: 3b. 數位邏輯 / 組合與循序電路
source_labels: [必背], [比較], [會畫]
...
- 只處理 topic id: cp-combinational-sequential-circuits
- 只讀來源：_private/計算機概論.txt
- 來源段落：3b. 數位邏輯 / 組合與循序電路
...
- source section: `3b. 數位邏輯 / 組合與循序電路`
- topic id: `cp-combinational-sequential-circuits`
- route: `/computer-principles`
...
以 組合與循序電路 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
