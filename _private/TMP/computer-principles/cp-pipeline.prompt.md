...
- 只處理 topic id: cp-pipeline
- 只讀來源：_private/計算機概論.txt
- 來源段落：3a. 基本計概 / Pipeline（管線化）
...
以 Pipeline（管線化） 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
