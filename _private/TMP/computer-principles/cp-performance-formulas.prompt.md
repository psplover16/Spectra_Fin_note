...
- 只處理 topic id: cp-performance-formulas
- 只讀來源：_private/計算機概論.txt
- 來源段落：3a. 基本計概 / 效能名詞與公式
...
- topic id: `cp-performance-formulas`
- route: `/computer-principles`
...
以 效能名詞與公式 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
