...
source_section: _private/資料庫.txt` lines 32-43
source_labels: [必背], [比較]
...
- 只處理 topic id: database-foundations
- 只讀來源：_private/資料庫.txt
- 來源段落：_private/資料庫.txt` lines 32-43
...
以 資料庫基礎 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
