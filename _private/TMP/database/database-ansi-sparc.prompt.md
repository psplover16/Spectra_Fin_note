...
source_section: _private/資料庫.txt` lines 10-30
...
# ANSI/SPARC 架構 Prompt

## Writer Scope

- 只處理 topic id: database-ansi-sparc
- 只讀來源：_private/資料庫.txt
- 來源段落：_private/資料庫.txt` lines 10-30
...
以 ANSI/SPARC 架構 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
