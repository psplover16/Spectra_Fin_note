...
route: /database
subject: database
source_file: _private/資料庫.txt
source_section: _private/資料庫.txt` lines 130-137
source_labels: [必背], [會寫], [必練], [易混淆], [會做]
...
- 只處理 topic id: database-supplemental-topics
- 只讀來源：_private/資料庫.txt
- 來源段落：_private/資料庫.txt` lines 130-137
...
以 資料庫補充考點 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
