...
source_section: _private/系統分析與設計.txt` L46-L49
source_labels: [補充], [會畫]
...
# 系統分析與設計：DFD、Data Dictionary、Structure Chart Prompt

## Writer Scope

- 只處理 topic id: programming-system-analysis-structured-tools
- 只讀來源：_private/系統分析與設計.txt
- 來源段落：_private/系統分析與設計.txt` L46-L49
...
以 系統分析與設計：DFD、Data Dictionary、Structure Chart 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
