...
source_section: _private/程式.txt` L68-L74
source_labels: [必背]
...
# Python 特殊資料型別 Prompt

## Writer Scope

- 只處理 topic id: programming-python-special-types
- 只讀來源：_private/程式.txt
- 來源段落：_private/程式.txt` L68-L74
...
以 Python 特殊資料型別 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
