...
source_section: _private/程式.txt` L39-L66
source_labels: [補充]
...
- 只處理 topic id: programming-intermediate
- 只讀來源：_private/程式.txt
- 來源段落：_private/程式.txt` L39-L66
...
以 程式中階 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
