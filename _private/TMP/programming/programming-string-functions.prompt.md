...
source_section: _private/程式.txt` L47-L51
source_labels: [必背], [會寫]
...
- 只處理 topic id: programming-string-functions
- 只讀來源：_private/程式.txt
- 來源段落：_private/程式.txt` L47-L51
...
以 程式字串相關函式 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
