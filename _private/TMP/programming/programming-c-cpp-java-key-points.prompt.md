...
source_section: _private/程式.txt` L78-L81
source_labels: [會寫]
...
# C、C++、Java 考點整理 Prompt

## Writer Scope

- 只處理 topic id: programming-c-cpp-java-key-points
- 只讀來源：_private/程式.txt
- 來源段落：_private/程式.txt` L78-L81
...
以 C、C++、Java 考點整理 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
