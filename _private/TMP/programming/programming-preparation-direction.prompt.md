...
source_section: _private/程式.txt` L3-L12
source_labels: [原文提醒]
...
- 只處理 topic id: programming-preparation-direction
- 只讀來源：_private/程式.txt
- 來源段落：_private/程式.txt` L3-L12
...
以 程式準備方向 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
