...
source_section: _private/系統分析與設計.txt` L3-L8
source_labels: [原文提醒]
...
- 只處理 topic id: programming-system-analysis-preparation-direction
- 只讀來源：_private/系統分析與設計.txt
- 來源段落：_private/系統分析與設計.txt` L3-L8
...
以 系統分析與設計：準備方向 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
