...
source_section: _private/程式.txt` L58-L61
source_labels: [補充]
...
- 只處理 topic id: programming-oop-extensions
- 只讀來源：_private/程式.txt
- 來源段落：_private/程式.txt` L58-L61
...
以 OOP 常見延伸 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
