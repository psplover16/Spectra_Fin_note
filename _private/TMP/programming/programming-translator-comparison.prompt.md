...
source_section: _private/程式.txt` L15-L18
source_labels: [比較]
...
# Assembler、Compiler、Interpreter 比較 Prompt

## Writer Scope

- 只處理 topic id: programming-translator-comparison
- 只讀來源：_private/程式.txt
- 來源段落：_private/程式.txt` L15-L18
...
以 Assembler、Compiler、Interpreter 比較 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
