---
topic_id: programming-system-analysis-pdca
formal_topic_id: programming-programming-system-analysis-pdca
subject: programming
source_files:
...
# 系統分析與設計：PDCA(Plan Do Check Act)

## 來源對應

- source files: `_private/系統分析與設計.txt`
- source section: `_private/系統分析與設計.txt` L98-L102`
- source labels: [必背]
...
- source section: `_private/系統分析與設計.txt` L98-L102`
- topic id: `programming-system-analysis-pdca`
- route: `/programming`
...
### [必背] 考試重點展開
- 能說明 系統分析與設計：PDCA(Plan Do Check Act) 的定義、用途與國考常見問法。
- 能從來源段落「_private/系統分析與設計.txt` L98-L102」整理出記憶點、理解說明、例子與易錯提醒。
- 能把系統分析與設計名詞、流程、圖形工具或專案管理觀念用中文(English Term) 格式表達。

### [必背] 最小背誦句與記憶支架
- 計畫(Plan) 是本 topic 的第一個必背名詞。
- 執行(Do) 要和 計畫 一起放入同一個比較或流程脈絡。
- 系統分析題要能寫出階段、工具、關係或導入風險，不能只背英文縮寫。

### [必背] 名詞定義與雙語術語
- 計畫(Plan)：本 topic 的必要術語；作答時先寫中文，再補英文全名、定義、用途或判斷線索。
- 執行(Do)：本 topic 的必要術語；作答時先寫中文，再補英文全名、定義、用途或判斷線索。
- 檢查(Check)：本 topic 的必要術語；作答時先寫中文，再補英文全名、定義、用途或判斷線索。
- 改善行動(Act)：本 topic 的必要術語；作答時先寫中文，再補英文全名、定義、用途或判斷線索。
- 持續改善(Continuous Improvement)：本 topic 的必要術語；作答時先寫中文，再補英文全名、定義、用途或判斷線索。

### [必背] 核心理解與應用脈絡
- 系統分析與設計的題目通常在問「如何把需求變成可建置、可測試、可維護的系統」，計畫(Plan) 要放回這個脈絡理解。
- 若題目要求比較，要先寫定義，再寫判斷標準、優缺點與適用情境。
- 若題目涉及圖形工具，要說明圖中節點、箭頭或關係的意義，不能只列圖名。

### [會做] 實際例子與操作步驟
題目：如何把「系統分析與設計：PDCA」整理成可作答教材？

1. 先定位來源段落：_private/系統分析與設計.txt` L98-L102。
2. 再寫出 計畫(Plan) 的定義與用途。
3. 最後補一個判斷線索、比較點或操作步驟，讓答案不只停在名詞背誦。

結果：系統分析與設計：PDCA 的最低作答線是定義清楚、英文對得上、能舉例並能指出易錯差異。
...
### [必背] 新手讀法與國考作答線
- 本主題的來源大綱只是輸入，不是最後答案；讀者要先知道「系統分析與設計：PDCA」在考試中通常是在問定義、流程、比較、計算或應用判斷。
