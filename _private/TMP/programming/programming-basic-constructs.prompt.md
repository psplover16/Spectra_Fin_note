...
source_section: _private/程式.txt` L20-L26
source_labels: [必背], [會寫]
...
- 只處理 topic id: programming-basic-constructs
- 只讀來源：_private/程式.txt
- 來源段落：_private/程式.txt` L20-L26
...
以 程式基本構件 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
