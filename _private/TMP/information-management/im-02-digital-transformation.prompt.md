...
source_file: _private/資訊管理.txt
source_section: 二、數位轉型
source_labels: [必背], [原文考點]
...
- 只處理 topic id: im-02-digital-transformation
- 只讀來源：_private/資訊管理.txt
- 來源段落：二、數位轉型
...
以 數位轉型 為核心，教會新手理解來源段落的定義、雙語術語、核心原理、應用情境、考場辨認法與易錯差異。
